...
class TimelineWidget:
    ...
    def onMouseDoubleClicked(self, event):
        if self.isSaveSelected():
            ...
            self.point.dictionaryUpdate(self.point, flag=True, values=(self.tag2time[int(self.currentPoint[1][1::])], self.point.params['x'], self.point.params['y'], self.point.params['z'], 0, 0, 0, 0))
